...
print(f'\nAcumulado de roubos de veiculos:{roubo.sum()}')
print(f'\nAcumulado de roubos de veiculos:{furto.sum()}')
print(f'\nAcumulado de roubos de veiculos:{rec.sum()}')
print(f'\nPercentual do acumulado de roubos e furtos de veiculos:{total_tx_rec:.2f}%')